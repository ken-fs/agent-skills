...
- 📐 **灵活比例**：支持 1:1、4:3、2.35:1、16:9、9:16 及自定义比例
- 🖼️ **封面图可选**：可生成概括全文的封面图
...
```
请选择图片比例：
1. 1:1      - 正方形 - 适合社交媒体头像、Instagram 方形帖子
2. 4:3      - 传统屏幕 - 适合演示文稿、传统显示器
3. 2.35:1   - 超宽电影 - 适合电影式横幅、宽屏展示
4. 16:9     - 宽屏横向 - 适合现代显示器、YouTube、PPT
5. 9:16     - 竖屏 - 适合手机、抖音、Instagram Story
6. 自定义比例 - 输入自定义宽高比
...
Claude: 好的，9:16 竖屏，不生成封面，8 张内容配图。
        [将文档归纳为 8 个主题]
        [展示归纳结果，用户确认后生成]
```
...
|------|-----------|-----------|----------|
| 1:1 | 2048x2048 | 4096x4096 | 社交媒体头像、Instagram 方形帖子 |
| 4:3 | 2048x1536 | 4096x3072 | 演示文稿、传统显示器 |
| 2.35:1 | 2560x1089 | 5120x2179 | 电影式横幅、宽屏展示 |
| 16:9 | 2560x1440 | 3840x2160 | 现代显示器、YouTube、PPT |
| 9:16 | 1440x2560 | 2160x3840 | 手机竖屏、抖音、Instagram Story |
| 自定义 | 自动计算 | 自动计算 | 任意自定义比例（如 3:2） |
